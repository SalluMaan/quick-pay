        ...
        <View style={styles.container}>
          ...
          <View style={styles.SendMoneyCard}>
            ...
            >
              <Picker_Input
                label="Account Name"
                labelOne="Select account"
                height={height_screen * 0.04}
              />
              <Picker_Input
                label="Account Type"
                labelOne="Select account type"
                height={height_screen * 0.04}
              />
              <Text_Input
                secureText={false}
          ...
          <View
            style={{ alignSelf: "center", marginTop: height_screen * 0.01 }}
          >
            <MainButton text="Submit Deposit" widthBtn={width_screen * 0.5} />
          </View>
        </View>
      </ScrollView>
    </>
